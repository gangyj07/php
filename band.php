...
<html lang="en">
  ...
  <body class="container">
    ...
    <button class="float-end btn btn-outline-dark" onclick="location.href='editBandInfo.php?bandInfo=greenday입니다.&vocal=김씨,박씨&guitar=이수자&bass=없음&drum=김아무개&otherSession=홍길동(캐스터네츠)'">정보수정</button>
    <br><br><br><br>
  </body>
</html>
